...
def predict_best_sell_day(df, buy_date):
    ...
    days_from_today = (buy_datetime.date() - datetime.now().date()).days  # Convert buy_datetime to date
...
if st.sidebar.button("Run Analysis"):
    ...
    # Display summary and best stock with buy/sell prices and profit estimate
    if results:
        ...
        if best_stock:
            ...
            buy_price = results[best_stock]['latest']['Close']  # Assume buy at current close
